...
_react2.default.createElement(_Main2.default, null), document.getElementById('app'));
  ...
  _createClass(Main, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get("/student").then(function (res) {
        _this2.setState({ students: res.data });
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(_StudentList2.default, { students: this.state.students });
    }
  }]);
